...
if( isset( $_POST['login'] ) ) {
    ...
    // create query
    $query = "SELECT username, password, privileges, fullname FROM users WHERE username='$formUsername'";
    ...
    if( mysqli_num_rows($result) > 0 ) {
        ...
        if( password_verify( $formPass, $hashedPass ) ) {
            ...
            $_SESSION['loggedInUserFullName'] = $fullname;
...
<body>
  ...
  <div class="loginbox">
      <img src="img/avatar_2x.png" class="avatar">
      <?php echo $loginError; ?>
